<template>
    <q-toolbar class="custom-header">
      <q-toolbar-title>
        <img src="../assets/vuee.png" alt="imagen vue">
      </q-toolbar-title>
...
<style scoped>
.custom-header {
  background: linear-gradient(90deg, #42b883, #35495e); /* Degradado Vue */
  color: white;
  box-shadow: 0px 3px 10px rgba(0, 73, 37, 138);
  height:67px;
}
.custom-header img{
  border-style: none;
