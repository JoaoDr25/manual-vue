<template>
  <q-page padding class="interpolacion-qr">
    ...
    <div class="blocks-qr">
      ...
      <div class="first-qr">
        <p>Se pueden hacer operaciones simples dentro de las llaves, aquí hay un ejemplo:</p>
...
&lt;/script&gt;
      ...
      <div class="second-qr">
        <p>Dentro de las llaves también se pueden usar operaciones o funciones simples:</p>
